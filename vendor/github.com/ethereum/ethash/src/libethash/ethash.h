...
#define ETHASH_DATASET_BYTES_INIT 8388608U // 2**23
#define ETHASH_DATASET_BYTES_GROWTH 0U  // 2**23
#define ETHASH_CACHE_BYTES_INIT 131072U // 2**17
#define ETHASH_CACHE_BYTES_GROWTH 0U  // 2**17
#define ETHASH_EPOCH_LENGTH 30000000U
